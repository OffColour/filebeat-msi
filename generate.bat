...
"C:\Program Files (x86)\WiX Toolset v3.11\bin\heat.exe" dir "Z:\WIX\Filebeat\source" -cg FilebeatFiles -gg -scom -sreg -sfrag -srd -dr INSTALLLOCATION  -var "var.FilebeatFilesDir" -t "excludeExe.xslt" -out "FilesFragment.wxs"
